...
To display this information you will use the transactions endpoint of the invoice: `https://api.business.plue.io/api/manager/businesses/<business_id>/invoices/<invoice-id>/transactions/`.
